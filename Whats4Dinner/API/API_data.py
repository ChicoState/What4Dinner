'''
Functions used for the Search functionality of the website.
'''
import requests
...
def format_url(url):
    '''
    Formats the whitespace in the URL
    '''
    encoded_url = ""
    for letter in url:
        if letter == " ":
...
def parse_api_data(data):
    ''''
    Parses the API response and only captures the fields we are going to display on the search page.
    '''
    parsed_data = []
